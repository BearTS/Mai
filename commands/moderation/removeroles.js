module.exports = {
  ...
  run: async (client, message, [ member ]) => {
    ...
    if (!member || !member.match(/\d{17,19}/))
      return message.channel.send(`<:cancel:712586986216489011> | ${message.author}, Please supply the ID or mention the member you want the roles to be reset.`)
    ...
    if (!continued)
      return message.channel.send(`<:cancel:712586986216489011> | ${message.author}, cancelled the removeroles command!`)
